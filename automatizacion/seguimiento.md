...
| `como-se-redisena-un-proceso-para-que-lo-ejecute-una-ia` | 2026-08-21 | ¿Cómo se rediseña un proceso para que lo ejecute en parte una IA? | 2026-09-20 | `revisado` | Quinta medición (30 días): sigue sin aparecer — supera las cuatro semanas. El elenco sigue siendo el más volátil del barrido: vuelven modernsalesia.substack.com y aicodingpatterns.com (habían salido la semana pasada), salen RSM Global, Alloxentric y agenciasdecomunicacion.org; entran rrhhdigital.com, crece30xai.substack.com, datadec.es y transformaciondigital.pe. Persisten empresas.entel.cl, agilenext.mx y networkautomationlabs.com — ninguna consultora grande se sostiene. **Revisado el 2026-09-23** siguiendo la hipótesis del informe (atacaba la pregunta de lado: el terreno es el más ruidoso del barrido porque nadie ha fijado todavía una respuesta lo bastante concreta y citable): se nombró el marco de las cinco preguntas — «el filtro de cinco preguntas» — en la entradilla, en el primer subtítulo, en el nombre de la sección del marco, en el destacado y en la primera FAQ, en los dos idiomas, y de paso se corrigió la FAQ en español e inglés, que solo enumeraba cuatro de los cinco criterios (le faltaba «rastro»). Slug y fecha de publicación sin tocar. Vuelve a contar cuatro semanas desde hoy |
...
| `tiene-mi-consejo-conocimiento-de-ia-para-supervisarla` | 2026-09-26 | ¿Tiene mi consejo de administración el conocimiento de IA suficiente para supervisarla, o solo la aprueba sin entenderla? | — | `nuevo` | Recomendación #8 del informe 2026-09-20 (huecos nuevos). Las cinco revisiones y las recomendaciones #6 y #7 ya estaban hechas; no hay informe más reciente que el del 2026-09-20, así que tocaba el siguiente hueco de la lista. Distinto de `por-donde-empieza-un-comite-de-direccion-con-ia`: aquel resuelve el punto de partida operativo del comité, este resuelve la capacidad fiduciaria de supervisión de un consejo que ya tiene el tema en marcha. Primera medición la semana que viene |
