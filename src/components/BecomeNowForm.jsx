...
const FIELDS = [
  ...
  { name: 'area', label: '¿Qué área quieres capacitar?', required: true, placeholder: 'Por ejemplo: Finanzas' },
  {
    name: 'participantes', label: '¿Cuántas personas participarían?',
  ...
  {
    name: 'herramientas', label: '¿Qué herramientas tenéis disponibles?', type: 'multi',
  ...
  {
    name: 'procesos', label: '¿Qué procesos o tareas quieres mejorar?', type: 'textarea', required: true, wide: true,
    help: 'Cuanto más concreto, mejor prepararemos la sesión de entendimiento.',
  },
  {
    name: 'modalidad', label: '¿Presencial, virtual o híbrida?', type: 'select',
    options: ['Aún no definida', 'Presencial', 'Virtual', 'Híbrida'], default: 'Aún no definida',
  },
  { name: 'timeline', label: '¿Para cuándo lo necesitáis?', placeholder: 'Por ejemplo: este trimestre' },
];
