  ...
  return (
    <>
      <div data-page-root="" style={{ font: "var(--type-body)", color: "var(--text-body)", background: "var(--off-white)", paddingTop: "72px" }}>
        <SiteHeader />
        <section data-band="--navy-900" data-bg-image="" data-node-state="0" style={{ position: "relative", overflow: "hidden", background: "var(--navy-900)", padding: "var(--space-14) var(--gutter-page) var(--space-13)" }}>
          ...
          <div style={{ position: "relative", maxWidth: "var(--maxw-content)", margin: "0 auto" }}>
            ...
            <div style={{ margin: "var(--space-9) 0 0", display: "flex", flexWrap: "wrap", gap: "var(--space-4)" }}>
              <Link to="/es/contacto" style={{ display: "inline-flex", alignItems: "center", minHeight: "52px", padding: "0 var(--space-7)", borderRadius: "var(--radius-pill)", background: "var(--electric-green)", color: "var(--deep-navy)", font: "var(--type-label)", letterSpacing: "var(--track-label)", textTransform: "uppercase", textDecoration: "none" }} className="hv-a750771">
                Inicia tu Discovery
              </Link>
              <Link to="/es/framework" style={{ display: "inline-flex", alignItems: "center", minHeight: "52px", padding: "0 var(--space-7)", borderRadius: "var(--radius-pill)", border: "1px solid var(--border-strong-dark)", color: "var(--white)", font: "var(--type-label)", letterSpacing: "var(--track-label)", textTransform: "uppercase", textDecoration: "none" }} className="hv-692648d">
        ...
        <section data-band="--off-white" data-node-state="1" style={{ background: "var(--off-white)", padding: "var(--space-13) var(--gutter-page)" }}>
        ...
        <section data-band="--navy-900" data-node-state="2" id="que-transformamos" data-deep="" style={{ position: "relative", background: "var(--navy-900)", padding: "var(--space-13) var(--gutter-page)" }}>
          <div style={{ maxWidth: "var(--maxw-content)", margin: "0 auto" }}>
            ...
            <Link to="/es/framework" style={{ display: "inline-flex", alignItems: "center", gap: "10px", margin: "var(--space-9) 0 0", minHeight: "44px", font: "var(--type-label)", letterSpacing: "var(--track-label)", textTransform: "uppercase", color: "var(--electric-green)", textDecoration: "none", borderBottom: "1px solid var(--green-line)" }}>
              Descubre qué cambia dentro →
            </Link>
          </div>
        </section>
        <section data-band="--off-white" id="propuesta" style={{ background: "var(--off-white)", padding: "var(--space-13) var(--gutter-page)" }}>
          <div style={{ maxWidth: "var(--maxw-content)", margin: "0 auto" }}>
            <p style={{ margin: "0", font: "var(--type-label)", letterSpacing: "var(--track-label)", textTransform: "uppercase", color: "var(--text-accent)" }}>
            ...
            <div style={{ margin: "var(--space-11) 0 0", display: "grid", gridTemplateColumns: "1fr auto 1fr", gap: "var(--space-8)", alignItems: "stretch" }} data-cols="">
              <Reveal as="article" data-lift="" style={{ background: "var(--white)", border: "1px solid var(--border-hairline)", padding: "var(--space-9)" }}>
                ...
                <Link to="/es/servicios/transformation-discovery" style={{ display: "inline-flex", alignItems: "center", margin: "var(--space-8) 0 0", minHeight: "44px", font: "var(--type-label)", letterSpacing: "var(--track-label)", textTransform: "uppercase", color: "var(--text-accent)", textDecoration: "none", borderBottom: "1px solid var(--border-strong)" }}>
                  Explora Discovery →
                </Link>
              </Reveal>
              ...
              <Reveal as="article" data-lift="" style={{ background: "var(--navy-900)", border: "1px solid var(--border-hairline-dark)", padding: "var(--space-9)" }}>
                ...
                <Link to="/es/servicios/build-and-embed" style={{ display: "inline-flex", alignItems: "center", margin: "var(--space-8) 0 0", minHeight: "44px", font: "var(--type-label)", letterSpacing: "var(--track-label)", textTransform: "uppercase", color: "var(--electric-green)", textDecoration: "none", borderBottom: "1px solid var(--green-line)" }}>
                  Explora Build & Embed →
                </Link>
              </Reveal>
            </div>
        ...
        <section data-band="--navy-900" data-node-state="3" data-deep="" style={{ background: "var(--navy-900)", padding: "var(--space-13) var(--gutter-page)" }}>
          <div style={{ maxWidth: "var(--maxw-content)", margin: "0 auto" }}>
            <p style={{ margin: "0", font: "var(--type-label)", letterSpacing: "var(--track-label)", textTransform: "uppercase", color: "var(--electric-green)" }}>
            ...
            <Link to="/es/framework" style={{ display: "inline-flex", alignItems: "center", margin: "var(--space-8) 0 0", minHeight: "44px", font: "var(--type-label)", letterSpacing: "var(--track-label)", textTransform: "uppercase", color: "var(--electric-green)", textDecoration: "none", borderBottom: "1px solid var(--green-line)" }}>
              Explora el BECOME framework →
            </Link>
          </div>
        </section>
        <section data-band="--navy-900" data-deep="" style={{ background: "var(--navy-900)", borderTop: "1px solid var(--border-hairline-dark)", padding: "var(--space-11) var(--gutter-page)" }}>
          <div style={{ maxWidth: "var(--maxw-content)", margin: "0 auto", display: "flex", flexWrap: "wrap", alignItems: "center", gap: "var(--space-8)", justifyContent: "space-between" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "var(--space-4)" }}>
              ...
              <Link to="/es/servicios/transformation-discovery" style={{ display: "inline-flex", alignItems: "center", minHeight: "52px", padding: "0 var(--space-7)", borderRadius: "var(--radius-pill)", border: "1px solid var(--border-strong-dark)", color: "var(--white)", font: "var(--type-label)", letterSpacing: "var(--track-label)", textTransform: "uppercase", textDecoration: "none" }} className="hv-692648d">
                Ver el servicio
              </Link>
            </div>
          </div>
        ...
        <section data-band="--off-white" style={{ background: "var(--off-white)", padding: "var(--space-13) var(--gutter-page)" }}>
          <div style={{ maxWidth: "var(--maxw-content)", margin: "0 auto", display: "grid", gridTemplateColumns: ".85fr 1.15fr", gap: "var(--space-11)" }} data-cols="">
            ...
            <Reveal as="div" style={{ display: "flex", flexDirection: "column" }}>
              ...
              <Link to="/es/framework#herramientas" style={{ display: "inline-flex", alignItems: "center", margin: "var(--space-7) 0 0", minHeight: "44px", font: "var(--type-label)", letterSpacing: "var(--track-label)", textTransform: "uppercase", color: "var(--text-accent)", textDecoration: "none", borderBottom: "1px solid var(--border-strong)" }}>
                Conoce cómo funcionan las herramientas →
              </Link>
            </Reveal>
          </div>
        </section>
        <section data-band="--pale-100" style={{ background: "var(--pale-100)", padding: "var(--space-13) var(--gutter-page)" }}>
          <div style={{ maxWidth: "var(--maxw-content)", margin: "0 auto" }}>
            <p style={{ margin: "0", font: "var(--type-label)", letterSpacing: "var(--track-label)", textTransform: "uppercase", color: "var(--text-accent)" }}>
              Value, made visible
            </p>
        ...
        <section data-band="--navy-900" data-deep="" style={{ background: "var(--navy-900)", padding: "var(--space-13) var(--gutter-page)" }}>
          <div style={{ maxWidth: "var(--maxw-content)", margin: "0 auto" }}>
            ...
            <Link to="/es/casos-de-uso" style={{ display: "inline-flex", alignItems: "center", margin: "var(--space-9) 0 0", minHeight: "44px", font: "var(--type-label)", letterSpacing: "var(--track-label)", textTransform: "uppercase", color: "var(--electric-green)", textDecoration: "none", borderBottom: "1px solid var(--green-line)" }}>
        ...
        <section data-band="--off-white" style={{ background: "var(--off-white)", padding: "var(--space-13) var(--gutter-page)" }}>
          <div style={{ maxWidth: "var(--maxw-content)", margin: "0 auto" }}>
            ...
            <div style={{ margin: "var(--space-10) 0 0", display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "var(--space-8)" }} data-cols="">
              <Reveal as={Link} to="/es/insights" style={{ textDecoration: "none", borderTop: "1px solid var(--border-strong)", paddingTop: "var(--space-5)" }} className="hv-4759c0e">
            ...
            <Link to="/es/insights" style={{ display: "inline-flex", alignItems: "center", margin: "var(--space-9) 0 0", minHeight: "44px", font: "var(--type-label)", letterSpacing: "var(--track-label)", textTransform: "uppercase", color: "var(--text-accent)", textDecoration: "none", borderBottom: "1px solid var(--border-strong)" }}>
              Lee las últimas ideas →
            </Link>
          </div>
        </section>
        <section data-band="--navy-950" data-bg-image="" data-node-state="4" style={{ position: "relative", overflow: "hidden", background: "var(--navy-950)", padding: "var(--space-14) var(--gutter-page)" }}>
