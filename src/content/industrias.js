...
export const INDUSTRIAS = [
  ...
  /* ------------------------------------------------ servicios financieros */
  {
    ...
    es: {
      ...
      capacidades: [
        ['Priorizar dónde está el valor', 'Mapear los procesos de crédito, fraude, operaciones, seguros o atención y ordenarlos por impacto, viabilidad, riesgo y velocidad de captura.', 'BECOME DISCOVER™'],
        ['Rediseñar una decisión', 'Definir qué información debe llegar, qué reglas aplican, dónde hay excepción, quién aprueba y qué evidencia debe quedar registrada.', 'Decision intelligence'],
        ['Construir copilotos y agentes con control', 'Búsqueda sobre políticas y procedimientos, extracción documental, agentes acotados a una tarea y conexión por API a los sistemas autorizados.', 'BECOME EMBED™'],
        ['Desarrollar a los equipos', 'Programas aplicados para Finanzas, Legal, Riesgos, Operaciones y Atención sobre sus propios expedientes y documentos.', 'BECOME NOW™'],
        ['Medir y transferir', 'Línea base, métricas, límites de autonomía, trazabilidad, responsable y manual de operación para que la capacidad quede dentro.', 'Transversal'],
      ],
    ...
    en: {
      ...
      capacidades: [
        ['Prioritise where the value is', 'Map credit, fraud, operations, insurance or service processes and rank them by impact, feasibility, risk and speed of capture.', 'BECOME DISCOVER™'],
        ['Redesign one decision', 'Define what information must arrive, which rules apply, where the exception sits, who approves and what evidence must be recorded.', 'Decision intelligence'],
        ['Build governed copilots and agents', 'Retrieval over policy and procedure, document extraction, agents scoped to a single task, and API access to authorised systems.', 'BECOME EMBED™'],
        ['Develop the teams', 'Applied programmes for Finance, Legal, Risk, Operations and Service, built on their own files and documents.', 'BECOME NOW™'],
        ['Measure and hand over', 'Baseline, metrics, autonomy limits, traceability, a named owner and an operating manual so the capability stays inside.', 'Across all three'],
      ],
  ...
  /* ------------------------------------------------------ minería y energía */
  {
    ...
    es: {
      ...
      capacidades: [
        ['Encontrar el proceso donde el conocimiento llega tarde', 'Mapear decisiones, fuentes, excepciones, dependencias y el tiempo que pasa entre la señal y la acción.', 'BECOME DISCOVER™'],
        ['Volver consultable el conocimiento operacional', 'Búsqueda empresarial sobre manuales, procedimientos, bitácoras, reportes y precedentes, con la fuente siempre a la vista.', 'Knowledge intelligence'],
        ['Construir copilotos de guardia, mantenimiento y parada', 'Asistentes que preparan contexto, pendientes y evidencia sin asumir decisiones críticas de seguridad ni de proceso.', 'BECOME EMBED™'],
        ['Desarrollar capacidades en los equipos', 'Programas aplicados para Operaciones, Mantenimiento, Ingeniería, Cadena de Suministro y las áreas corporativas.', 'BECOME NOW™'],
        ['Diseñar el control operativo', 'Definir qué puede preparar un sistema, qué exige aprobación humana, qué se registra y cómo se reconstruye una acción después.', 'Transversal'],
      ],
    ...
    en: {
      ...
      capacidades: [
        ['Find where knowledge arrives too late', 'Map decisions, sources, exceptions, dependencies and the time lost between signal and action.', 'BECOME DISCOVER™'],
        ['Make operational knowledge searchable', 'Enterprise search over manuals, procedures, logs, reports and precedent, with the source always visible.', 'Knowledge intelligence'],
        ['Build shift, maintenance and shutdown copilots', 'Assistants that prepare context, open items and evidence without taking safety or process-critical decisions.', 'BECOME EMBED™'],
        ['Develop capability in the teams', 'Applied programmes for Operations, Maintenance, Engineering, Supply Chain and corporate functions.', 'BECOME NOW™'],
        ['Design the operating controls', 'Define what a system may prepare, what requires human approval, what gets logged and how an action is reconstructed afterwards.', 'Across all three'],
      ],
  ...
  /* -------------------------------------------------------- retail y consumo */
  {
    ...
    es: {
      ...
      capacidades: [
        ['Priorizar el ciclo de mayor valor', 'Comparar oportunidades entre lo comercial, el catálogo, el pedido, la atención, el contenido y la tienda.', 'BECOME DISCOVER™'],
        ['Diseñar copilotos de decisión comercial', 'Reunir señales de venta, stock, precio y contexto en una misma preparación para que la revise una persona.', 'Decision intelligence'],
        ['Construir operaciones de contenido', 'Sistemas que generan y adaptan fichas y piezas dentro de las reglas de marca, producto y aprobación.', 'BECOME EMBED™'],
        ['Construir agentes de atención y excepción', 'Agentes acotados para pedidos, entrega, retiro en tienda, devoluciones y consultas, con salida clara hacia una persona.', 'BECOME EMBED™'],
        ['Desarrollar a Marketing, Comercial y Atención', 'Programas aplicados sobre los materiales, las decisiones y los procesos reales de cada área.', 'BECOME NOW™'],
      ],
    ...
    en: {
      ...
      capacidades: [
        ['Prioritise the cycle that carries the value', 'Compare opportunities across commercial, catalogue, order, service, content and store.', 'BECOME DISCOVER™'],
        ['Design commercial decision copilots', 'Bring sales, stock, price and context signals into one preparation for a person to review.', 'Decision intelligence'],
        ['Build content operations', 'Systems that generate and adapt product pages and assets within brand, product and approval rules.', 'BECOME EMBED™'],
        ['Build service and exception agents', 'Agents scoped to orders, delivery, click and collect, returns and queries, with a clear exit to a person.', 'BECOME EMBED™'],
        ['Develop Marketing, Commercial and Service', 'Applied programmes built on each team’s real materials, decisions and processes.', 'BECOME NOW™'],
      ],
  ...
  /* ------------------------------------------------------ travel y hotelería */
  {
    ...
    es: {
      ...
      capacidades: [
        ['Priorizar el momento que más presión concentra', 'Comparar reserva, llegada, estancia, incidencia y postestancia por volumen, impacto en la experiencia y viabilidad.', 'BECOME DISCOVER™'],
        ['Construir copilotos de reserva y atención', 'Disponibilidad, servicios, condiciones y políticas, con escalamiento explícito de cualquier excepción.', 'BECOME EMBED™'],
        ['Volver consultable la operación', 'Procedimientos y estándares por rol, accesibles en el turno, sin buscar entre carpetas ni preguntar a quien esté libre.', 'Knowledge intelligence'],
        ['Coordinar incidencias entre áreas', 'Un mismo contexto para recepción, pisos y mantenimiento, con el pendiente y el responsable a la vista.', 'BECOME EMBED™'],
        ['Desarrollar a Atención, Operaciones y Comercial', 'Programas aplicados sobre las consultas, las incidencias y las cotizaciones reales del hotel o la agencia.', 'BECOME NOW™'],
      ],
    ...
    en: {
      ...
      capacidades: [
        ['Prioritise the moment under most pressure', 'Compare booking, arrival, stay, disruption and post-stay by volume, impact on experience and feasibility.', 'BECOME DISCOVER™'],
        ['Build booking and service copilots', 'Availability, services, conditions and policy, with explicit escalation for any exception.', 'BECOME EMBED™'],
        ['Make the operation searchable', 'Procedures and standards by role, available during the shift instead of buried in folders.', 'Knowledge intelligence'],
        ['Coordinate incidents across teams', 'One shared context for front desk, housekeeping and maintenance, with the open item and its owner visible.', 'BECOME EMBED™'],
        ['Develop Service, Operations and Commercial', 'Applied programmes built on the property’s real queries, incidents and quotes.', 'BECOME NOW™'],
      ],
  ...
  /* --------------------------------------------- real estate y construcción */
  {
    ...
    es: {
      ...
      capacidades: [
        ['Priorizar dónde una demora cuesta más', 'Comparar el ciclo comercial, el expediente, la obra y la postventa por impacto en plazo, costo y riesgo contractual.', 'BECOME DISCOVER™'],
        ['Construir el copiloto comercial y el expediente de venta', 'Inventario, precios y documentación aprobada en una consulta, y el paso de separación a minuta con sus pendientes a la vista.', 'BECOME EMBED™'],
        ['Construir asistentes de RFI, metrados y valorización', 'Recuperar especificaciones, planos y precedentes, y preparar el sustento antes de que lo revise el responsable.', 'BECOME EMBED™'],
        ['Leer contratos y cambios con trazabilidad', 'Encontrar obligaciones, hitos y comunicaciones, y comparar versiones para preparar el expediente de sustento.', 'Contract intelligence'],
        ['Desarrollar a Finanzas Inmobiliarias, PMO y Obra', 'Programas aplicados sobre los contratos, valorizaciones y expedientes reales del proyecto.', 'BECOME NOW™'],
      ],
    ...
    en: {
      ...
      capacidades: [
        ['Prioritise where delay costs most', 'Compare the sales cycle, the permit file, site work and after-sales by impact on schedule, cost and contractual risk.', 'BECOME DISCOVER™'],
        ['Build the sales copilot and the sale file', 'Inventory, pricing and approved documentation in one query, and the path from reservation to contract with its open items visible.', 'BECOME EMBED™'],
        ['Build RFI, quantity and valuation assistants', 'Retrieve specifications, drawings and precedent, and prepare the supporting evidence before the responsible party reviews it.', 'BECOME EMBED™'],
        ['Read contracts and changes with traceability', 'Find obligations, milestones and correspondence, and compare versions to prepare the supporting file.', 'Contract intelligence'],
        ['Develop Real Estate Finance, PMO and Site teams', 'Applied programmes built on the project’s real contracts, valuations and files.', 'BECOME NOW™'],
      ],
  ...
  /* ------------------------------------------- healthcare y life sciences */
  {
    ...
    es: {
      ...
      capacidades: [
        ['Encontrar un trámite administrativo medible', 'Ordenar los trámites por volumen, tiempo, retrabajo, riesgo y viabilidad, y elegir uno que no toque la decisión clínica.', 'BECOME DISCOVER™'],
        ['Diseñar asistentes que saben cuándo escalar', 'Recuperación sobre políticas y procedimientos, extracción documental y un límite explícito ante cualquier consulta que deje de ser administrativa.', 'Decision intelligence'],
        ['Implementar el proceso administrativo asistido', 'Integrar la capacidad priorizada con las fuentes y sistemas autorizados, con permisos y registro de lo consultado.', 'BECOME EMBED™'],
        ['Desarrollar capacidades corporativas', 'Programas aplicados para Operaciones, Recursos Humanos, Compras, Finanzas, Legal y Marketing sobre su trabajo real.', 'BECOME NOW™'],
        ['Diseñar privacidad y trazabilidad', 'Definir fuentes, permisos, tratamiento de datos personales, registro, escalamiento y revisión humana antes de operar.', 'Transversal'],
      ],
    ...
    en: {
      ...
      capacidades: [
        ['Find a measurable administrative process', 'Rank procedures by volume, time, rework, risk and feasibility, and choose one that never touches the clinical decision.', 'BECOME DISCOVER™'],
        ['Design assistants that know when to escalate', 'Retrieval over policy and procedure, document extraction, and an explicit limit whenever a query stops being administrative.', 'Decision intelligence'],
        ['Implement the assisted administrative process', 'Integrate the prioritised capability with authorised sources and systems, with permissions and a record of what was consulted.', 'BECOME EMBED™'],
        ['Develop corporate capability', 'Applied programmes for Operations, HR, Procurement, Finance, Legal and Marketing, built on their real work.', 'BECOME NOW™'],
        ['Design privacy and traceability', 'Define sources, permissions, personal-data handling, logging, escalation and human review before anything operates.', 'Across all three'],
      ],
