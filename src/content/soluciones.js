...
export const SOLUCION_CONTENIDO = {
  ...
  'preparar-equipos-para-ia': {
    ...
    dentroTexto: 'People desarrolla criterio y confianza para usar IA. Operations convierte los casos aprendidos en workflows repetibles. Data define qué información puede utilizarse y Agents deja de ser una herramienta aislada para participar dentro de tareas concretas, con revisión y estándares comunes.',
  ...
  'agentes-de-ia-con-control': {
    ...
    dentroTexto: 'Agents ejecuta dentro de límites explícitos. Operations define el workflow, las excepciones y el responsable. Data controla fuentes, accesos y trazabilidad. People supervisa y aprende a intervenir. Products convierte esa interacción en una experiencia comprensible para quien la utiliza.',
