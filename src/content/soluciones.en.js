...
export const SOLUCION_CONTENIDO = {
  'scale-ai-beyond-pilots': {
    ...
    capacidades: [
      ['Direction', 'Decide whether this pilot should scale, stop or be redesigned, and on what business case.'],
      ['Build', 'Integrations, controls, evaluation and the work a person is holding together by hand today.'],
      ['Value', 'Baseline, a scale-or-stop threshold and an owner of the outcome.'],
    ],
  ...
  'prepare-teams-for-ai': {
    ...
    capacidades: [
      ['People', 'Applied training on the team’s real work, not on catalogue examples.'],
      ['Work', 'Turn what was learned into shared processes, with common validation criteria.'],
      ['Value', 'Adoption measured by real use and by what stopped being done by hand.'],
    ],
  ...
  'redesign-critical-workflows': {
    ...
    capacidades: [
      ['Work', 'Redesign of the process, the decision, the roles, the exceptions and the approval points.'],
      ['Build', 'The capability that runs the redesigned step, with its limits and its traceability.'],
      ['Value', 'Cycle time, rework and exceptions, measured before and after.'],
    ],
    engagement: 'BECOME DISCOVER™ + BECOME EMBED™',
  ...
  'deploy-governed-ai-agents': {
    ...
    capacidades: [
      ['Build', 'The agent, its integrations, its evaluations and the record of what it consulted.'],
      ['Work', 'What it decides, what escalates to a person, who approves and who owns the outcome.'],
      ['Value', 'Accuracy, escalation rate and how often human review actually changed the decision.'],
    ],
  ...
  'build-ai-enabled-products': {
    ...
    capacidades: [
      ['Direction', 'Where AI changes the value proposition and not only the internal process.'],
      ['Build', 'The AI-native product or experience, with the operation that sustains it behind.'],
      ['Value', 'Usage, retention and the revenue or saving the new capability makes possible.'],
    ],
  ...
  'measure-and-govern-ai-value': {
    ...
    capacidades: [
      ['Value', 'Baseline, metrics agreed before intervening and an owner per outcome.'],
      ['Direction', 'What keeps being funded, what stops and what scales, on explicit criteria.'],
      ['Work', 'Controls and review built into everyday work, not into a separate committee.'],
    ],
